...
public class PlantillaRegex
{
	 ...
	 * la expresión, en vez de cuando se est� ejecutando la lectura de ficheros
	 * 
	 * @param texto
	 * 
	 * @param _campo
	...
	/**
	 * Cualquier car�cter, número, signo, etc. es v�lido
	 * 
	 * @return
	 */
	...
	/**
	 * Signo m�s (+) para anteceder a números positivos, y signo menos (-) para
	 * los negaticos
	 * 
	 * @return
	 */
	...
	private static void pruabaEsNumeroEntero()
		...
		prueba( "Número entero debe contener al menos una cifra: con texto vac�o", !esNumeroEntero( "" ) );
		prueba( "Número entero s�lo contiene cifras 123", esNumeroEntero( "123" ) );
		...
		prueba( "Número entero no debe tener s�lo signo +", !esNumeroEntero( "+" ) );
		}

	private static void pruebaEsNumero()
		{
		System.out.println( "----Número" );
		prueba( "Número debe contener al menos una cifra: con texto vac�o", !esNumero( "" ) );
		...
		prueba( "Número debe contener al menos una cifra: s�lo punto", !esNumero( "." ) );
		prueba( "Número no tiene m�s de un punto decimal 1.2.3", !esNumero( "1.2.3" ) );
		}
