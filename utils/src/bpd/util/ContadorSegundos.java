...
/**
 * Contador que se incrementa autom�ticamente cada segundo a partir de ejecutar
 * <code>arrancaContador</code>. A cada segundo comunica al usuario la cantidad
 * de segundos pasados a trav�s del método {@link #segundo(int)} que el usuario
...
public class ContadorSegundos
{
	...
	/**
	 * Valor actual los segundos que han pasado desde que se arranc� el contador
	 * 
	 * @return
	 */
	...
	/**
	 * Pon el contador en marcha. A partir de aquí, cada segundo se notificar� a
	...
	/**
	 * Utilidad para convertir un valor num�rico (<code>_segundos</code>) en
