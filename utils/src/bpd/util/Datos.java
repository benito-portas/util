...
public class Datos
{
	 ...
	 * <li>Separador se entiende lo que no es un dígito hexadecimal (0-9, a-f,
	 * A-F)
	 ...
	 * también de izquierda a derecha</li>
	 * 
	 * </p
	 * 
	 * <p>
	 ...
	 * @see #deTexto(String)
	 * @param _hex
	 *            Texto con dígitos hexadecimales, y signos de separación entre
	 *            ellos
	 * @return
	 */
	public static byte[] aDatos( String _hex )
		...
		/*
		 * Hago la longitud par para que pueda contar más adelante de dos en dos
	...
	/**
	 * Amplía <code>_datos</code> a la <code>_longitud</code> con el
	 * <code>_valorRelleno</code> añadido a la derecha
	 * 
	 * 
	 * @param _datos
	 * @param _longitud
	...
	/**
	 * Representa la secuencia <code>_datos/code> con códigos hexadecimales.
	 * Sólo intervienen los datos a partir de <code>_posInicial</code>
	 *
	 * @param _datos
	 *            Datos a representar
	 * @param _posInicial
	...
	/**
	 * Convierte a cifra hex (0..9,a..f) el <code>_dato</code>, valiendo sólo
	...
	/**
	 * Toma sólo los datos a partir de la <code>_posicionInicial</code>
	 * 
	 ...
	 * <code>_posInicial</code> y <code>_posFinal</code> (ésta excluida)
	 * 
	 * <p>
	 ...
	 * @param _c
	 *            Carácter a utilizar como relleno
	 ...
	 * @param _is
	 * @param _cantidad
	 * @return Los datos leídos, o nada, si se ha llegado al fin del fichero
	 * 
	 * @throws IOException
	 *             Si la cantidad de bytes leídos no es la misma
	 *             <code>_cantidad</code>
	 */
	public static byte[] leeDe( InputStream _is, int _cantidad ) throws IOException
		...
		if( leido != _cantidad )
			throw new IOException( String.format( "Registro corrupto: longitud=%d, pero leído=%d", _cantidad, leido ) );
